...
fn keycode_to_string(keys: Keycode) -> &'static str{
    match keys {
        ...
        keymap::Keycode::LControl => " Ctrl ",
        keymap::Keycode::RControl => " Ctrl ",
        keymap::Keycode::LShift => " Shift ",
        keymap::Keycode::RShift => " Shift ",
        keymap::Keycode::LAlt => " Alt ",
        keymap::Keycode::RAlt => " Alt ",
        keymap::Keycode::Meta => "Meta",
        keymap::Keycode::Enter => " -> ",
        keymap::Keycode::Up => " ArrowUp ",
        keymap::Keycode::Down => " ArrowDown ",
        keymap::Keycode::Left => " ArrowLeft ",
        keymap::Keycode::Right => " ArrowRight ",
